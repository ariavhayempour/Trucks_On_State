    ...
    const sampleTrucks: InsertFoodTruck[] = [
      ...
      // Surco Food Cart
      {
        ...
        menu: [
          ...
          { name: "Chicken Adobo, GF", price: "$13.00", description: "Slow-braised chicken strips in tangy adobo sauce, brown lentils, jasmine rice, cabbage, and organic spring mix with homemade passion fruit dressing.", category: "Chicken Dishes" },
          { name: "Pastel De Papa (Scalloped Potatoes)", price: "$13.00", description: "Golden-baked potatoe slices layered with cheese, grilled chicken, cabbage, and organic spring mix with homemade passion fruit dressing.", category: "Chicken Dishes" },
          { name: "Arroz Chaufa", price: "$13.00", description: "Wok stir-fried rice elevated with unique blends of homemade sauces (including sesame oil, soy sauce, & scrambled eggs), grilled chicken, cabbage, and organic spring mix with passion fruit dressing.", category: "Chicken Dishes" },

          // Start of vegitarian section
          { name: "Cilantro Rice, GF", price: "$13.00 / $8.00", description: "Flavorful, fluffy jasmine rice cooked with fresh cilantro & herbs; cabbage, andorganic spring mix with homemade passion fruit dressing.", category: "Vegetarian Dishes" },
          { name: "Arroz Chaufa, ", price: "$12.00", description: "Wok stir-fried rice, scrambled eggs packed with our unique blend of sauces (including soy sauce and sesame oil), sliced avocado, cabbage, and organic spring mix with homemade passion fruit dressing.", category: "Vegetarian Dishes" },
          { name: "Pastel De Papa (Scalloped Potatoes)", price: "$12.00", description: "Golden-baked potatoe slices layered with cheese, sliced avocado, cabbage, and organic spring mix with homemade passion fruit dressing.", category: "Vegetarian Dishes" },
          ...
          // Beverages
          { name: "Inka Kola | San Pellegrino", price: "$3.00", description: "", category: "Beverages" },
          { name: "Coke | LaCroix | Water ", price: "$2.00", description: "", category: "Beverages" },
        ],
        schedule: {
